...
object KeyboardLayouts {
    ...
    // شماره‌ی کوچیکی که گوشه‌ی هر کلید ردیف اول نشون داده می‌شه (شبیه کیبورد سیستمی) — اعداد انگلیسی
    val PERSIAN_ROW1_DIGIT_HINTS: List<String> =
        listOf("1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-")

    // نگاشتِ کاراکترِ جایگزین برای فشارِ طولانی (لانگ‌پرس)، شبیه کیبورد شیائومی:
    // نگه‌داشتنِ حروفِ ردیفِ اول → عددِ انگلیسیِ متناظر، و نگه‌داشتنِ «ی» → «ئ»
    val PERSIAN_LONG_PRESS: Map<String, String> = mapOf(
        "ض" to "1", "ص" to "2", "ث" to "3", "ق" to "4", "ف" to "5",
        "غ" to "6", "ع" to "7", "ه" to "8", "خ" to "9", "ح" to "0", "ج" to "-",
        "ی" to "ئ"
    )
    ...
    // صفحه‌ی ایموجی (از دکمه‌ی 😊 تو ردیف بالای کیبورد باز می‌شه)
    val EMOJI: List<List<String>> = listOf(
        listOf("😀", "😂", "😍", "😊", "😉", "😎", "🤔", "😴", "😢", "😭", "😡"),
        listOf("👍", "👎", "👏", "🙏", "💪", "❤️", "🔥", "🎉", "✨", "💯", "😘"),
        listOf("😅", "😁", "🙂", "🙃", "😐", "😱", "🥰", "😇", "🤗", "😜")
    )
